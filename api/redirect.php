...
<head>
    ...
    <!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=AW-11178849207"></script>
...
<script>
  ...
  gtag('config', 'AW-11178849207');
</script>

<!-- Event snippet for Phone Number Clicks - GAC conversion page
...
function gtag_report_conversion(url) {
  ...
  gtag('event', 'conversion', {
      'send_to': 'AW-11178849207/UivICIS9lsAZELfnvtIp',
...
<!-- Event snippet for SLF -TYPV - GAC conversion page -->
<script>
  gtag('event', 'conversion', {'send_to': 'AW-11178849207/EHZvCPqBgsAZELfnvtIp'});
</script>
	...
	<title>Thank you l Buff Creative College</title>
...
<body>
	...
	<div class="main-content">
		...
		<p class="main-content__body" data-lead-id="main-content-body">For Quick Admission & Details Reach Us On<br /> 91 50 60 1717 </p>
	</div>
	<br><br>
