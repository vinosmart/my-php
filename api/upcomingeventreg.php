                ...
                <div class="container">
                    ...
                    <div class="row" style="position:relative;">
                        ...
                        <div class="col-sm-12 col-xs-12  col-md-6 col-xl-3 mt-80">
                            <div class="card p-2 br-2 workshop-icon" style="height: 240px;">
                        ...
                        <div class="col-sm-12 col-xs-12  col-md-6 col-xl-3 mt-80">
                            <div class="card p-2 br-2 workshop-icon" style="height: 240px;">
                                ...
                                <div class="card-body text-center">
                                    <p>The graphic design industry includes many activities, corporate identity/branding, advertising, print production, and web design.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12 col-xs-12  col-md-6 col-xl-3 mt-80">
                ...
                <section class="timeline_area section_padding_130">
                    <div class="container mt-100">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-12 col-xl-12 mt-100 mb-30">
                                <div id="eventtime2" class="text-center date">
