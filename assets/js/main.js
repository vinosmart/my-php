...
(function ($) {
	...
	$(".portfolio-active").imagesLoaded(function () {
		...
		// Filter items to show only the ones with the class .initial-item on page load
		$grid.isotope({ filter: ".chennai" });
                 ...
                 if ($('.sidebar_inner').length) {
                     $('.sidebar_inner').sticky({
						transition: 2000,
                         ...
                         disableOn: 993,
						 onStick: function() {
							$('.sidebar_inner').addClass('sticky');
						  },
						  onUnstick: function() {
							$('.sidebar_inner').removeClass('sticky');
						  }
                     });
                 };
