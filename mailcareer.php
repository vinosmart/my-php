<?php    
    // Only process POST reqeusts.
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
          ...
          //  $to = 'venkataraman.bcc@gmail.com'; 
            $from =  $_POST['cvname']; 
            $fromName = $_POST['cvname']; 
            $headers = ''; 
           ...
           $headers .= 'Cc: shamalaveni.bcc@gmail.com' . "\r\n";
            ...
            $message = "<table class='bordered' width='600' align='center'><tbody><tr>
                            ...
                            <td align='center' bgcolor='#f9fafb'>".$_POST['cvname']."</td>
                            </tr>			   
                            <tr align='center'><td bgcolor='#f9fafb' height='60'>Mobile No.</td>
                            <td align='center' bgcolor='#f9fafb'>:</td><td align='center' bgcolor='#f9fafb'>".$_POST['cvphone']."</td></tr>	
                            
                            <tr align='center'><td bgcolor='#f9fafb' height='60'>Email</td>
                            <td align='center' bgcolor='#f9fafb'>:</td><td align='center' bgcolor='#f9fafb'>".$_POST['cvemail']."</td></tr>
                            </tbody></table>";
